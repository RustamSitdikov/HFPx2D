...
namespace hfp2d {
    il::Array2D<double>
    stresscalculation(Mesh mesh, il::Array2D<int> id, int p, const double Ep,
                      double xg, double yg);

    il::Array<double>
    stressoutput(Mesh mesh, il::Array2D<int> id, int p, const double Ep,
                 double xg, double yg, il::Array<double> width);
}
